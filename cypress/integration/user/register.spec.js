...
// const registerWithoutRequired = visitURLAndRemoveRequiredAttributes('/user/register');

const registerWithoutRequired = () => {
	cy.visit(url('/user/register'), {onLoad: (contentWindow) => {
...
describe('Registration page', function () {
	...
	it('Links to login page', function () {
		cy.contains('Already have an account? Log in here.')
